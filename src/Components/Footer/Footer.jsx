...
export default function App() {
  return (
    <footer
      className="bg-[#64003E] text-center text-slate-100 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      <div
      ...
      {/* <!--Copyright section--> */}
      <div className="bg-[#974b7a] p-6 text-center dark:bg-neutral-700">
