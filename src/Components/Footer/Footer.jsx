...
export default function App() {
  return (
    <footer
      className="bg-[#5E1675] text-center text-slate-100 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      <div
      ...
      {/* <!--Copyright section--> */}
      <div className="bg-[#8E7AB5] p-6 text-center dark:bg-neutral-700">
